...
public class ExampleWithAnyIncludedHeaders3 {
	public ExampleWithAnyIncludedHeaders3() {
...
//		Logger.log("Start Logger", LogType.HEADER, ExampleWithAnyIncludedHeaders3.class.getSimpleName());
		Logger.log(LogType.HEADER, "firstAction");
		new Thread(() -> {
			Logger.log(LogType.HEADER, "myAction");
			Logger.log("myAction");
		}).start();
		logAnySubActions("1");
