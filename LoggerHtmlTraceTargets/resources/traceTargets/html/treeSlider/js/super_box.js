(function (i) {
    var l, t, r, q, a, p, h, o, j, w, b = {boxId: "superbox", boxClasses: "", overlayOpacity: 0.8, boxWidth: "600", boxHeight: "400", loadTxt: "Loading...", closeTxt: "Close", prevTxt: "Previous", nextTxt: "Next", beforeShow: function () {
    }}, x = {}, m = false, s = i([]);
    i.superbox = function () {
        w = i.extend({}, b, i.superbox.settings);
        n();
        z()
    };
    function z() {
        i("a[rel^=superbox],area[rel^=superbox]").each(function () {
            var D = i(this), F = D.prop("rel"), B = F.match(/^superbox\[([^#\.\]]+)/)[1], E = F.replace("superbox", "").match(/([#\.][^#\.\]]+)/g) || [], C = w.boxId, A = w.boxClasses;
    ...
    i.extend(i.superbox, {image: function (C, A, B) {
        ...
        C.click(function (F) {
            ...
            y(function () {
                ...
                G = i('<img src="' + C.prop("href") + '" title="' + (C.prop("title") || C.text()) + '" />');
                G.load(function () {
                    g(G, H);
        ...
        B.click(function (D) {
            ...
            y(function () {
                ...
                E = i('<iframe src="' + B.prop("href") + '" name="' + B.prop("href") + '" frameborder="0" scrolling="auto" hspace="0" width="' + A.boxWidth + '" height="' + A.boxHeight + '"></iframe>');
                E.load(function () {
        ...
        B.click(function (D) {
            ...
            y(function () {
                ...
                q.width(A.boxWidth + "px");
                $innerbox.height(A.boxHeight + "px");
                i(B.prop("href")).clone().appendTo($innerbox).show();
    ...
    function e(A) {
        q.prop("id", A.boxId).prop("class", A.boxClasses)
    }
